...
(defn init
  ...
  (db/update-board-name "2ch.net" "qb5.2ch.net" "saku2ch" "çÌèúóvêø")
  (db/update-board-name "2ch.net" "qb7.2ch.net" "operate2" "â^ópèÓïÒ(ã‡)")
  (db/update-board-name "2ch.net" "peace.2ch.net" "sakhalin" "2chäJî≠é∫")
  (db/update-board-name "2ch.net" "peace.2ch.net" "myanmar" "Ç‹ÇΩíßêÌÅB")
  (db/update-board-name "2ch.net" "peace.2ch.net" "yangon" "Ç‹ÇΩíßêÌÇQÅB")
  (db/update-board-name "2ch.net" "invisible.2ch.net" "invisible" "INVISIBLE")
  (db/update-board-name "2ch.net" "hato.2ch.net" "sato" "îEé“ÇÃó¢")
  (db/update-board-name "2ch.net" "ipv6.2ch.net" "refuge" "îìÔèä")
  (db/update-board-name "2ch.net" "yuzuru.2ch.net" "mu" "å∂ÇÃëÂó§")
  (do
    (future
      (do
